...
const Supplier = () => {
    ...
    const fetchProducts = async () => {
        try {
            const response = await axios.get('https://e-commerce-energetico.onrender.com/products/all');
    ...
    const fetchSuppliers = async () => {
        ...
        try {
            const response = await axios.get('https://e-commerce-energetico.onrender.com/suppliers/all', { headers: headers }); 
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('https://e-commerce-energetico.onrender.com/suppliers/newsupplier', formData, { headers });
