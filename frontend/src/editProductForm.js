...
const EditProductForm = ({ productId }) => {
  ...
  const fetchProductDetails = async () => {
    try {
      const response = await axios.get('https://e-commerce-energetico.onrender.com/users/newuser', formData);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`https://e-commerce-energetico.onrender.com/products/${productId}`, formData, { headers });
